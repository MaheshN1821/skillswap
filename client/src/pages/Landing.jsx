      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-purpal-900 via-indigo-900 to-blue-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="text-center">
            ...
            <h1 className="text-6xl md:text-8xl font-extrabold text-white mb-8 leading-tight -mt-20">
              Trade Skills,
            ...
            <p className="text-lg text-blue-200/80 mb-8 max-w-2xl mx-auto leading-relaxed">
              Join a revolutionary community where knowledge flows freely. Teach
              what you master, learn what you dream.
            </p>
            ...
            {!user && (
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Link
                  to="/register"
                  className="group px-10 py-5 w-[60%] lg:w-[35%] bg-gradient-to-r from-cyan-400 to-blue-500 text-white rounded-2xl font-bold text-lg hover:from-cyan-500 hover:to-blue-600 transition-all duration-300 shadow-2xl hover:shadow-cyan-500/25"
                >
                ...
                <Link
                  to="/login"
                  className="px-10 py-5 bg-white/10 w-[60%] lg:w-[35%] backdrop-blur-sm border-2 border-white/30 text-white rounded-2xl font-bold text-lg hover:bg-white/20 hover:border-white/50 transition-all duration-300"
                >
                  Sign In
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl font-bold text-slate-900 mb-6">
              Simple, Fair & Community-Driven
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Our platform creates a balanced ecosystem where every skill has
              value and every learner becomes a teacher.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Share your expertise and earn valuable points for every hour you
                dedicate to teaching others. Your knowledge becomes your
                currency.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Use your hard-earned points to unlock new skills from talented
                teachers in our community. Every point opens new possibilities.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Rate experiences, provide feedback, and help build a trusted
                network where quality learning thrives and relationships
                flourish.
              </p>
            </div>
          </div>
      ...
      <section className="py-32 bg-gradient-to-br from-slate-50 to-indigo-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Get insights into your progress, manage your sessions, and
              discover new opportunities all in one place.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 hover:shadow-2xl transition-all duration-300 border border-gray-300">
              ...
              <p className="text-slate-600">
                Track your learning milestones and teaching impact with detailed
                insights.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 hover:shadow-2xl transition-all duration-300 border border-gray-300">
              ...
              <p className="text-slate-600">
                Monitor your earned points and plan your next skill acquisition
                strategy.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 hover:shadow-2xl transition-all duration-300 border border-gray-300">
              ...
              <p className="text-slate-600">
                Easily book and manage your teaching and learning sessions.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 hover:shadow-2xl transition-all duration-300 border border-gray-300">
              ...
              <p className="text-slate-600">
                Get personalized recommendations for skills to learn and teach.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Explore trending skill categories where thousands of learners and
              teachers connect every day.
            </p>
          </div>
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">
                        Join thousands learning and teaching this skill
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          {!user && (
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link
                to="/register"
                className="group px-12 w-[70%] py-5 bg-gradient-to-r from-cyan-400 to-blue-500 text-white rounded-2xl font-bold text-xl hover:from-cyan-500 hover:to-blue-600 transition-all duration-300 shadow-2xl hover:shadow-cyan-500/25"
              >
              ...
              <Link
                to="/login"
                className="px-12 py-5 w-[70%] bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white rounded-2xl font-bold text-xl hover:bg-white/20 hover:border-white/50 transition-all duration-300"
              >
                Explore Community
              </Link>
            </div>
